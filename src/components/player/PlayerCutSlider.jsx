  ...
  return (
    ...
    >
      ...
      <div
        ...
        className="vx-player-cut-panel absolute rounded-[22px] border border-grayout-extra-dark bg-[#182223B8] p-5 text-white backdrop-blur-md backdrop-saturate-150"
        style={{
          width: PANEL_WIDTH,
          left: position.x,
          top: position.y,
